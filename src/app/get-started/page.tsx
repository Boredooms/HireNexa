    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-[#0f0f1e] to-black">
      <div className="w-full max-w-4xl px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          <Link
            href="/sign-up/user"
            className="group block p-8 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-[#3B82F6]"
          >
            <div className="text-center">
              {/* Icon */}
              <div className="inline-block mb-6 p-6 bg-[#3B82F6]/20 rounded-full border border-[#3B82F6]/50 group-hover:bg-[#3B82F6]/30 transition">
              ...
              {/* Button */}
              <div className="px-8 py-4 bg-gradient-to-r from-[#3B82F6] to-[#2563EB] text-white font-bold rounded-lg border border-[#3B82F6] group-hover:shadow-lg group-hover:shadow-[#3B82F6]/50 transition text-lg">
          ...
          <Link
            ...
            className="group block p-8 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-red-500"
          >
            <div className="text-center">
              {/* Icon */}
              <div className="inline-block mb-6 p-6 bg-red-500/20 rounded-full border border-red-500/50 group-hover:bg-red-500/30 transition">
                <span className="text-6xl">💼</span>
              </div>
              ...
              {/* Button */}
              <div className="px-8 py-4 bg-red-600 text-white font-bold rounded-lg border border-red-600 group-hover:shadow-lg group-hover:shadow-red-600/50 transition text-lg">
